...
public class CreateActivity extends BaseActivity {
    ...
    EditText edt_create_code,edt_create_type,edt_create_description;
    Button btnsubir;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab_create_save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String code,description,type;
                boolean active;

                code = edt_create_code.getText().toString();
                description = edt_create_description.getText().toString();
                type = edt_create_type.getText().toString();
    ...
    private void save(ApartmentModel model) {
                    ...
                    public void onComplete(@NonNull Task<DocumentReference> task) {
                        if(task.isSuccessful()){
                            if(task.getResult() != null){
                                makeSimpleAlertDialog("Success", "Apartments saved");
                                clear();
                            }else{
                                makeSimpleAlertDialog("Warning","Apartments not saved");
                            }
                        }else{
    ...
    protected void init(){
        ...
        edt_create_code = findViewById(R.id.edt_create_code);
        edt_create_type = findViewById(R.id.edt_create_type);
    ...
    private void clear(){
        ...
        edt_create_type.setText("");
        edt_create_code.setText("");

        edt_create_code.requestFocus();
        iv_create_image.setImageResource(R.drawable.ic_apartment_black_18dp);
    }
        ...
        if(requestCode == GALLERY_INTENT && requestCode == RESULT_OK){
            ...
            filepath.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    Toast.makeText(CreateActivity.this, "se subio corretamente ", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
